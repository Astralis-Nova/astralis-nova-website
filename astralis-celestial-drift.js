(()=>{
  ...
  const removeRetiredDarktidePromo=()=>{
    document.getElementById('darktideLaunch')?.remove();
    document.getElementById('darktidePanel')?.remove();
    document.querySelectorAll('style').forEach(style=>{
      if(style.textContent?.includes('#darktideLaunch')||style.textContent?.includes('#darktidePanel'))style.remove();
    });
