export async function onRequest(context) {
  ...
  return new HTMLRewriter()
    ...
    .on("body", {
      element(element) {
        element.append('<script src="/astralis-performance-loader.js?v=20260722v" defer></script><script src="/biography-pet-photobook.js?v=20260725b" defer></script>', { html: true });
      },
    })
    .transform(response);
}
