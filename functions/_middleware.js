export async function onRequest(context) {
  ...
  if (isHomepage) {
    rewriter
      ...
      .on("body", {
        element(element) {
          element.append('<script src="/astralis-performance-loader.js?v=20260901jukebox" defer></script><script src="/astralis-motion-restore.js?v=20260727a" defer></script>', { html: true });
        },
      });
  }
  ...
  if (isBiography) {
    rewriter.on("body", {
      element(element) {
        element.append('<script src="/biography-pet-photobook.js?v=20260831a" defer></script>', { html: true });
      },
    });
  }
