(() => {
  ...
  function installLegacy83Radio(){
    ...
    module.className='hifi-module tuner-module is-powered';
    module.innerHTML=`
      <div class="hifi-label"><span>AM / FM STEREO TUNER</span><span id="tunerStatus">FM STEREO</span></div>
      <div class="tuner-face">
        ...
        <div class="tuner-presets" aria-label="Station presets">
          <span>MEMORY</span>
          ${[1,2,3,4,5,6].map(n=>`<button type="button" data-preset="${n-1}">${n}</button>`).join('')}
        </div>
      </div>`;
    ...
    style.textContent=`
      .tuner-module{min-height:278px;overflow:hidden}
      .tuner-face{position:relative;min-height:240px;padding:12px 16px 14px;background:linear-gradient(180deg,#b9b8b2 0,#8f908c 4%,#c9c7c0 11%,#969692 15%,#777875 100%);box-shadow:inset 0 1px #fff9,inset 0 -8px 18px #0005}
      ...
      .tuner-glass{position:relative;height:112px;border:4px solid #303336;border-radius:3px;background:linear-gradient(180deg,#07151d,#031017 58%,#061d28);box-shadow:inset 0 0 22px #000,0 2px 5px #0008;overflow:hidden;color:#bdefff}
      ...
      .tuner-band-scale{position:absolute;left:18px;right:18px;display:grid;grid-template-columns:32px repeat(6,1fr);align-items:center;font:700 .48rem/1 system-ui,sans-serif;letter-spacing:.08em;text-shadow:0 0 7px #6ee7ff}.tuner-band-scale small{color:#f2cb74;font-size:.43rem}.tuner-fm-scale{top:13px}.tuner-am-scale{top:39px;color:#86ccdc}.tuner-ticks{position:absolute;left:53px;right:20px;top:29px;height:29px;background:repeating-linear-gradient(90deg,#8fe8ff 0 1px,transparent 1px 3.4%);opacity:.48}
      ...
      .tuner-readout{position:absolute;left:17px;bottom:9px;display:flex;align-items:baseline;gap:5px;color:#d9f7ff;text-shadow:0 0 8px #45dfff}.tuner-readout b{font:700 1.05rem/1 ui-monospace,monospace;letter-spacing:.06em}.tuner-readout small{font-size:.43rem;letter-spacing:.1em}.tuner-readout strong{margin-left:12px;font-size:.48rem;letter-spacing:.13em;color:#f3d28a;white-space:nowrap}
      .tuner-lamps{position:absolute;right:14px;bottom:8px;display:flex;gap:7px;font-size:.36rem;letter-spacing:.08em}.tuner-lamps span{padding:3px 5px;border:1px solid #315a47;color:#5d8c76;background:#07110c;box-shadow:inset 0 0 5px #000}.tuner-module.is-tuned .signal-lamp,.tuner-module.is-tuned .stereo-lamp{color:#aaffc6;border-color:#6aa47e;box-shadow:inset 0 0 7px #29e27077,0 0 5px #29e27055}
      .tuner-controls{display:grid;grid-template-columns:54px 72px 34px minmax(130px,1fr) 34px 78px;gap:9px;align-items:center;margin-top:10px}.tuner-controls button,.tuner-presets button{border:1px solid #35383a;border-bottom-color:#111;border-radius:2px;background:linear-gradient(#70716f,#333634);color:#eee;box-shadow:inset 0 1px #fff4,0 2px 3px #0008;text-shadow:0 1px #000;min-height:28px;font-weight:800}.tuner-controls button:active,.tuner-presets button:active{transform:translateY(1px);box-shadow:inset 0 2px 4px #0008}.tuner-power{display:grid;place-items:center;padding:2px}.tuner-power b{color:#72ff86;font-size:.6rem}.tuner-power small{font-size:.3rem;letter-spacing:.08em}.tuner-band-buttons{display:grid;grid-template-columns:1fr 1fr;gap:3px}.tuner-band-buttons button.active{color:#d9f7ff;box-shadow:inset 0 0 8px #55cfff88,0 2px 3px #0008}.tuner-slider-wrap{display:grid;gap:3px;color:#202426;font-size:.34rem;font-weight:900;letter-spacing:.1em;text-align:center}.tuner-slider-wrap input{width:100%;accent-color:#243f4c}.tuner-signal{height:28px;display:flex;align-items:end;gap:3px;padding:3px 5px;border:1px solid #333;background:#151918}.tuner-signal span{width:10px;height:20%;background:#31523d;box-shadow:0 0 4px #000}.tuner-signal span:nth-child(2){height:35%}.tuner-signal span:nth-child(3){height:52%}.tuner-signal span:nth-child(4){height:72%}.tuner-signal span:nth-child(5){height:95%}.tuner-signal span.on{background:#70e996;box-shadow:0 0 5px #4cff88}
      ...
      .tuner-module:not(.is-powered) .tuner-glass{filter:brightness(.28) saturate(.25)}.tuner-module:not(.is-powered) .tuner-power b{color:#4a514b}.tuner-module:not(.is-powered) .tuner-signal span{background:#28302a;box-shadow:none}
      @media(max-width:620px){.tuner-module{min-height:264px}.tuner-face{min-height:226px;padding:9px 8px}.tuner-brand{font-size:.34rem}.tuner-brand strong{font-size:.46rem}.tuner-glass{height:106px}.tuner-band-scale{left:8px;right:8px;grid-template-columns:25px repeat(6,1fr);font-size:.36rem}.tuner-ticks{left:34px;right:8px}.tuner-readout{left:8px}.tuner-readout b{font-size:.82rem}.tuner-readout strong{font-size:.34rem;margin-left:5px;max-width:122px;overflow:hidden;text-overflow:ellipsis}.tuner-lamps{right:7px}.tuner-controls{grid-template-columns:44px 62px 28px minmax(84px,1fr) 28px 60px;gap:4px}.tuner-controls button{min-height:26px;font-size:.4rem}.tuner-power small{font-size:.24rem}.tuner-signal{gap:2px;padding:3px}.tuner-signal span{width:6px}.tuner-presets{gap:3px}.tuner-presets button{min-width:27px;padding:2px 5px}}
    `;
    ...
    powerBtn.addEventListener('click',()=>{
      powered=!powered;module.classList.toggle('is-powered',powered);powerBtn.setAttribute('aria-pressed',String(powered));
