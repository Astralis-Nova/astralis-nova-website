(() => {
  ...
  function installStyles() {
    ...
    style.textContent = `
      ...
      .planet-rainbow{background:conic-gradient(from 210deg,#ff5d73,#ffb14a,#ffe478,#6ee6a8,#67c8ff,#9a7bff,#f27ad8,#ff5d73);box-shadow:inset -13px -13px 18px rgba(0,0,0,.28),0 0 24px rgba(255,179,222,.35)}
  ...
  function addConnectedWorlds() {
    ...
    section.innerHTML = `
      ...
      <div class="astralis-system">
        ...
        <a class="astralis-planet-link" href="/conquest.html" aria-label="Open the Conquest world"><span class="astralis-planet planet-conquest ringed" aria-hidden="true"></span><span class="astralis-planet-copy"><strong>Conquest</strong><span>Asheron’s Call ACE server information, Discord, connection address, and live-status links.</span><span class="astralis-world-badge">Game World</span></span></a>
        <a class="astralis-planet-link" href="https://emulator.ac/" target="_blank" rel="noopener noreferrer" aria-label="Open ACEmulator Forge"><span class="astralis-planet planet-ace" aria-hidden="true"></span><span class="astralis-planet-copy"><strong>ACEmulator Forge</strong><span>The open-source engine and community rebuilding the world of Dereth.</span><span class="astralis-world-badge">External Portal</span></span></a>
        <a class="astralis-planet-link" href="/biography.html" aria-label="Open Biography Moon"><span class="astralis-planet planet-biography" aria-hidden="true"></span><span class="astralis-planet-copy"><strong>Biography Moon</strong><span>The life, memories, technology, family, and imagination behind Astralis Nova.</span><span class="astralis-world-badge">Story World</span></span></a>
        <a class="astralis-planet-link" href="#first-orbit" aria-label="Open First Orbit"><span class="astralis-planet planet-orbit ringed" aria-hidden="true"></span><span class="astralis-planet-copy"><strong>First Orbit</strong><span>Archived pages and MIDI relics preserved from Ramon’s earliest corner of the web.</span><span class="astralis-world-badge">Archive World</span></span></a>
        <a class="astralis-planet-link" href="#guestbook" aria-label="Open Guestbook Moon"><span class="astralis-planet planet-guestbook" aria-hidden="true"></span><span class="astralis-planet-copy"><strong>Guestbook Moon</strong><span>Sign your name, choose a favorite song, and leave a signal among the stars.</span><span class="astralis-world-badge">Visitor World</span></span></a>
        <a class="astralis-planet-link" href="/rainbow-promise.html" aria-label="Open The Rainbow Promise reflection"><span class="astralis-planet planet-rainbow ringed" aria-hidden="true"></span><span class="astralis-planet-copy"><strong>Rainbow Promise</strong><span>Rain, Noah’s ark, the covenant, and hope carried across the sky after a storm.</span><span class="astralis-world-badge">Reflection World</span></span></a>
      </div></div>`;
